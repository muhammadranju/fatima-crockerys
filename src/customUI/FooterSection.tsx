        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center ">
                <img
                  src="../../logo.png"
                  className="border bg-white border-white w-8 h-8 p-1 rounded-full"
                  alt="Fatima Crockery"
                />
                <span className="ml-1 text-1xl font-bold">Fatima Crockery</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.twitter.com/officialfatimastore">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="14"
                      height="11"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.instagram.com/officialfatimastore">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
