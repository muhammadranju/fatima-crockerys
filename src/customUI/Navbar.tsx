    ...
    <div className="relative w-full shadow top-1">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          <span>
            {/* <svg
              className="border-2 bg-white border-white w-12 h-12 p-1 rounded-full"
              width="30"
              height="30"
              viewBox="0 0 50 56"
              fill="none"
        ...
        {isMenuOpen && (
          <div className="absolute inset-x-0 top-0 z-50 origin-top-right transform p-2 transition lg:hidden">
            <div className="divide-y-2 bg-stone-300 opacity-95 divide-gray-50 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    <span>
                      {/* <svg
                        className="border-2 bg-black border-white w-12 h-12 p-1 rounded-full"
                        width="30"
                        height="30"
                        viewBox="0 0 50 56"
                        fill="none"
                    ...
                    <span className="font-bold text-black">FMC</span>
                  </div>
                  <div className="-mr-2">
                    <button
                      type="button"
